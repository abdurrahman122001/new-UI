      ...
      <CardContent className="p-8">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-lg p-4 border border-cyan-500/30">
            ...
            <button className="w-full mt-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg py-2 text-sm font-bold transition-colors">
              Boost
            </button>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="w-full bg-slate-700 rounded-full h-3">
            <div 
              className="bg-gradient-to-r from-cyan-400 via-purple-500 to-yellow-400 h-3 rounded-full transition-all duration-500"
